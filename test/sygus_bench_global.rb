...
class SygusTest < Minitest::Test
  ...
  run_sygus_test('./sygus-strings/bikes.sl', heuristic: "global")
  run_sygus_test('./sygus-strings/dr-name.sl',
    {:name => StringPrefix.top}, StringPrefix.val("Dr. ", false))
  run_sygus_test('./sygus-strings/firstname.sl', heuristic: "global")

  # TIMEOUT
  run_sygus_test('./sygus-strings/initials.sl',
    {:name => ProductDomain.top}, ProductDomain.val(StringSuffix.val(".", false), StringLength.val(4, 4)), heuristic: "global")

  # (str.substr name (str.indexof name " " 0) (str.len name))
  run_sygus_test('./sygus-strings/lastname.sl', heuristic: "global")

  run_sygus_test('./sygus-strings/name-combine-2.sl',
      {:firstname => StringSuffix.top,
       :lastname  => StringSuffix.top}, StringSuffix.val(".", false), heuristic: "global")

  # (str.++ (str.++ (str.++ (str.substr firstname 0 1) ".") " ") lastname)
  run_sygus_test('./sygus-strings/name-combine-3.sl',
      {:firstname => StringSuffix.top,
       :lastname  => StringSuffix.var('lname')}, StringSuffix.var('lname'), heuristic: "global")
  ...
  run_sygus_test('./sygus-strings/name-combine-4.sl',
      ...
      ProductDomain.val(StringPrefix.var('lname'), StringSuffix.val('.', false)), heuristic: "global")

  run_sygus_test('./sygus-strings/name-combine.sl', heuristic: "global")
  run_sygus_test('./sygus-strings/phone-1.sl', heuristic: "global")

  # TIMEOUT
  run_sygus_test('./sygus-strings/phone-10.sl', heuristic: "global")

  run_sygus_test('./sygus-strings/phone-2.sl', heuristic: "global")

  # TIMEOUT
  run_sygus_test('./sygus-strings/phone-3.sl',
    {:name => StringLenExt.val(11)}, StringLenExt.val(13), heuristic: "global")

  run_sygus_test('./sygus-strings/phone-4.sl', heuristic: "global")

  run_sygus_test('./sygus-strings/phone-5.sl', heuristic: "global")

  run_sygus_test('./sygus-strings/phone-6.sl',
    {:name => StringLenExt.var('name')}, StringLenExt.val(3), heuristic: "global")
  ...
  run_sygus_test('./sygus-strings/phone-9.sl',
    {:name => name_var}, res, heuristic: "global")

  run_sygus_test('./sygus-strings/phone.sl', heuristic: "global")

  run_sygus_test('./sygus-strings/reverse-name.sl', heuristic: "global")

  run_sygus_test('./sygus-strings/univ_1.sl', heuristic: "global")
