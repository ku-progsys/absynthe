...
class SygusTest < Minitest::Test
  ...
  run_sygus_test('./sygus-strings/firstname.sl', heuristic: "noheuristic")

  # TIMEOUT
  run_sygus_test('./sygus-strings/initials.sl',
    {:name => ProductDomain.top}, ProductDomain.val(StringSuffix.val(".", false), StringLength.val(4, 4)), heuristic: "noheuristic")

  # (str.substr name (str.indexof name " " 0) (str.len name))
  run_sygus_test('./sygus-strings/lastname.sl', heuristic: "noheuristic")

  run_sygus_test('./sygus-strings/name-combine-2.sl',
      {:firstname => StringSuffix.top,
       :lastname  => StringSuffix.top}, StringSuffix.val(".", false), heuristic: "noheuristic")

  # (str.++ (str.++ (str.++ (str.substr firstname 0 1) ".") " ") lastname)
  run_sygus_test('./sygus-strings/name-combine-3.sl',
      {:firstname => StringSuffix.top,
       :lastname  => StringSuffix.var('lname')}, StringSuffix.var('lname'), heuristic: "noheuristic")
  ...
  run_sygus_test('./sygus-strings/name-combine-4.sl',
      ...
      ProductDomain.val(StringPrefix.var('lname'), StringSuffix.val('.', false)), heuristic: "noheuristic")

  run_sygus_test('./sygus-strings/name-combine.sl', heuristic: "noheuristic")
  run_sygus_test('./sygus-strings/phone-1.sl', heuristic: "noheuristic")

  # TIMEOUT
  run_sygus_test('./sygus-strings/phone-10.sl', heuristic: "noheuristic")

  run_sygus_test('./sygus-strings/phone-2.sl', heuristic: "noheuristic")

  # TIMEOUT
  run_sygus_test('./sygus-strings/phone-3.sl',
    {:name => StringLenExt.val(11)}, StringLenExt.val(13), heuristic: "noheuristic")

  run_sygus_test('./sygus-strings/phone-4.sl', heuristic: "noheuristic")

  run_sygus_test('./sygus-strings/phone-5.sl', heuristic: "noheuristic")

  run_sygus_test('./sygus-strings/phone-6.sl',
    {:name => StringLenExt.var('name')}, StringLenExt.val(3), heuristic: "noheuristic")
  ...
  run_sygus_test('./sygus-strings/phone-9.sl',
    {:name => name_var}, res, heuristic: "noheuristic")

  run_sygus_test('./sygus-strings/phone.sl', heuristic: "noheuristic")

  run_sygus_test('./sygus-strings/reverse-name.sl', heuristic: "noheuristic")

  run_sygus_test('./sygus-strings/univ_1.sl', heuristic: "noheuristic")
