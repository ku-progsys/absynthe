...
def tableSygusResults(entcsv: str, noent: str):
    ...
    numeric_columns = ["Time Median (s)", "Time SIQR (s)", "# Ex", "Size", "Tested Progs"]
    ...
    output = pd.DataFrame({
        ...
        "#Ex": merged["# Ex_abs_on"],  # Assumed identical across files.
